                            ...
                            <div className='space-y-5 mt-4'>
                                <div className='flex items-center mb-6 justify-start gap-2'>
                                    ...
                                    <a href='https://www.linkedin.com/in/majidul-islam7' target="_blank"
                                        rel="noopener noreferrer" className='border p-2 rounded-full bg-black bg-gradient-to-r hover:from-purple-600 hover:to-blue-500'>  <FaLinkedinIn className='md:text-2xl' /></a>
                                </div>
                                <a download
