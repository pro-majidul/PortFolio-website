            ...
            <div className=' md:my-5 md:py-5 grid md:grid-cols-2  items-start justify-between gap-10 space-y-5'>
                ...
                >
                    ...
                    <div class="flex -space-x-2 xl:-space-x-3 rtl:space-x-reverse">
                        <div class="bg-gray-600/10 backdrop-blur-xl border border-white/10 shadow-lg w-14 h-14 xl:w-[65px] xl:h-[65px] 2xl:w-[75px] 2xl:h-[75px] rounded-full flex items-center justify-center">
