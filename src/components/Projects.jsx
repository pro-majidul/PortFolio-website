                                    ...
                                    <div className="max-w-lg md:p-3 p-2 shadow-md bg-gradient-to-r hover:scale-105 transition-all from-blue-500 to-purple-500 rounded-xl">
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Link to={`/details/${project.id}`} className='flex items-center gap-1 md:w-5/12  w-6/12 bg-green-950 px-4 py-1 rounded-xl hover:bg-green-800'><span className='text-white'>View Details </span> <FaArrowRightLong className='text-yellow-400' /></Link>
                                            </div>
                                        </div>
                                    </div>
                                </Fade>
